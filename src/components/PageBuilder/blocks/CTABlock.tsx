...
export const CTABlockComponent: React.FC<CTABlockComponentProps> = ({ block, isEditing }) => {
  const { title, description, buttonText, buttonUrl, backgroundColor, textColor } = block.data;

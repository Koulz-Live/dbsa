...
export const HeroBlockComponent: React.FC<HeroBlockComponentProps> = ({ block, isEditing }) => {
  const { title, subtitle, backgroundImage, ctaText, ctaUrl, alignment } = block.data;
